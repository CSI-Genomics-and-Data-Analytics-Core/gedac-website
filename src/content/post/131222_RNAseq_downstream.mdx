...
tags:
  ...
  - architecture
---
import figure1_exptDesing from '~/assets/images/rnaseq/13122022_RNAseq_downstream/figure1_exptDesign.png';
...
![Summary of experimental design for Fu et al., (2015) \label{exptDesign}](/src/assets/images/rnaseq/13122022_RNAseq_downstream/figure1_exptDesign.png "Figure 1: Summary of experimental design for Fu et al., 2015")
...
![RNA-seq downstream results A) Top-level directory structure B) Contents of subfolders \label{dirStructure}](/src/assets/images/rnaseq/13122022_RNAseq_downstream/figure2_dirstructure.png "Figure 2: RNA-seq downstream results A) Top-level directory structure B) Contents of subfolders")
...
![Reactome pathway enrichment analysis results A) Bar plot B) Dot plot C) UpSet plot D) Emap Plot E) Cnet plot \label{reactome}](/src/assets/images/rnaseq/13122022_RNAseq_downstream/figure6_reactome.png "Figure 6: Reactome pathway enrichment analysis results A) Bar plot B) Dot plot C) UpSet plot D) Emap Plot E) Cnet plot")
